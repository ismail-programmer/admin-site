...
c0,8.282,6.714,14.996,14.996,14.996c8.282,0,14.996-6.714,14.996-14.996C332.022,200.251,311.84,180.07,287.033,180.07z"
    ...
    const allUsers = [audio,video,"",audio,video,"",audio,video,"",audio,video,"",audio,video,"",audio,video,"",audio,video,"",audio,video,""];
    ...
    return (
      <div>
        <div className="welcome_popup">
          ...
          <div className="video_container" style={{textAlign: `center`}}>
            <video autoPlay={true} width="50%" muted={true} src="https://downloadstatus.xyz/latest/Love-me-like-you-do-heart-eyes-Whatsapp-status.mp4"></video>
          </div>
          <div className="chat_container">
            <Messages maxHeight="100px" messages={messages} />
            <form
              action="/"
              onSubmit={(e) => {
                e.preventDefault();
            ...
            <div className="all_calls">{this.showCall()}</div>
          </div>
        </div>
      </div>
    );
